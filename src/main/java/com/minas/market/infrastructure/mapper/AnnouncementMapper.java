...
public interface AnnouncementMapper {
    ...
    @Mapping(target = "announcementCategory", source = "category")
    @Mapping(target = "userId", source = "idAuthenticatedUser")
    AnnouncementEntity toEntity(AnnouncementRequest announcementRequest, UUID idAuthenticatedUser, AnnouncementCategoryEntity category);
